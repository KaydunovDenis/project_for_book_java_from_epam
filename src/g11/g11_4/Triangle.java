...
public class Triangle extends JFrame {
    ...
    public static g11.g11_4.Point[] massivPoint;
    public static int countPoint = 5;
    public static int sizePoint = 5;
    public g11.g11_4.Point[] massivPointsTriangle;
    public static int diam = 100;//отступ


    g11.g11_4.Point point1;
    g11.g11_4.Point point2;
    g11.g11_4.Point point3;
    ...
    public void paint(Graphics g) {
       ...
       // g.drawString(msg, 50, 50);
        ...
        for (g11.g11_4.Point point: massivPoint) {
        ...
        for (g11.g11_4.Point point: massivPointsTriangle) {
    ...
    public Triangle() {
        massivPointsTriangle = new g11.g11_4.Point[3];
    ...
    public void analyzePointRelativeTriangle(g11.g11_4.Point point) {
        int x0 = point.x;
        int y0 = point.y;
        int x1 = point1.x;
        int y1 = point1.y;
    ...
    public static void generatePoint(g11.g11_4.Point[] massivPoint, int countPoint) {
        for (int i = 0; i < countPoint; i++) {
            int x = (int) (Math.random() * (width - 2 * diam)) + diam;
            int y = (int)(Math.random()* (height - 2 * diam)) + diam;
            massivPoint[i] = new g11.g11_4.Point(x, y, i + "");
            System.out.println(massivPoint[i].toString());
        }
    }

    public void analyzePointRelaiveLine(Graphics g, Line line, g11.g11_4.Point point) {
